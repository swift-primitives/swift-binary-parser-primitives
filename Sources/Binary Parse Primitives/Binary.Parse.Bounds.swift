// Binary.Parse.Bounds.swift
// swift-binary-parser-primitives
//
// Bounds parse fault.
//
// Re-homed from swift-binary-primitives' `Binary.Error.Bounds`.
...
extension Binary.Parse.Bounds {
    /// Creates a bounds fault from any BinaryInteger values.
    @inlinable
...
extension Binary.Parse.Bounds: CustomStringConvertible {
    public var description: String {
        "\(field) out of bounds (was \(value), valid: \(lower)...\(upper))"
    }
}

extension Binary.Parse.Bounds.Field: CustomStringConvertible {
    public var description: String {
        switch self {
