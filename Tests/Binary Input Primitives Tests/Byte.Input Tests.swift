...
extension Byte.Input.Test.Unit {
    ...
    func `count returns correct value`() {
        let input = Byte.Input([0x01, 0x02, 0x03, 0x04, 0x05])
    ...
    func `first returns first byte`() {
        let input = Byte.Input([0xAB, 0xCD, 0xEF])
    ...
    func `advance by count skips multiple bytes`() {
        var input = Byte.Input([0x01, 0x02, 0x03, 0x04, 0x05])
    ...
    func `subscript respects consumed bytes`() throws {
        var input = Byte.Input([0x10, 0x20, 0x30, 0x40])
    ...
    func `starts with returns true for matching prefix`() {
        let input = Byte.Input([0x01, 0x02, 0x03, 0x04])
    ...
    func `starts with returns true for empty prefix`() {
        let input = Byte.Input([0x01, 0x02])
...
extension Byte.Input.Test.Integration {
    ...
    func `sequential byte consumption works correctly`() throws {
        var input = Byte.Input([0x01, 0x02, 0x03, 0x04])
    ...
    func `parse fixed-width integer manually`() throws {
        var input = Byte.Input([0xDE, 0xAD, 0xBE, 0xEF])
